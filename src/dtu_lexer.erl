...
map_escaped_char(Escaped, Line) ->
    case Escaped of
      ...
      $v ->
          $\v;
      _ ->
          throw({error, {Line, fn_lexer, ["unrecognized escape sequence: ", [$\\, Escaped]]}})
    end.
...
yystate(48, [10 | Ics], Line, Tlen, _, _) ->
    yystate(44, Ics, Line + 1, Tlen + 1, 25, Tlen);
...
yystate(46, [C | Ics], Line, Tlen, Action, Alen) when C >= 60, C =< 63 ->
    yystate(28, Ics, Line, Tlen + 1, Action, Alen);
...
yystate(32, [10 | Ics], Line, Tlen, _, _) ->
    yystate(44, Ics, Line + 1, Tlen + 1, 24, Tlen);
...
yystate(29, Ics, Line, Tlen, _, _) ->
    {19, Tlen, Ics, Line, 29};
yystate(28, [94 | Ics], Line, Tlen, _, _) ->
...
yystate(28, [33 | Ics], Line, Tlen, _, _) ->
    yystate(28, Ics, Line, Tlen + 1, 22, Tlen);
yystate(28, [C | Ics], Line, Tlen, _, _) when C >= 60, C =< 63 ->
    yystate(28, Ics, Line, Tlen + 1, 22, Tlen);
...
yystate(16, [10 | Ics], Line, Tlen, _, _) ->
    yystate(24, Ics, Line + 1, Tlen + 1, 13, Tlen);
...
yystate(15, [10 | Ics], Line, Tlen, _, _) ->
    yystate(7, Ics, Line + 1, Tlen + 1, 14, Tlen);
...
yystate(9, [C | Ics], Line, Tlen, Action, Alen) when C >= 93, C =< 95 ->
    yystate(6, Ics, Line, Tlen + 1, Action, Alen);
yystate(9, [C | Ics], Line, Tlen, Action, Alen) when C >= 97 ->
    yystate(6, Ics, Line, Tlen + 1, Action, Alen);
...
yystate(5, [10 | Ics], Line, Tlen, _, _) ->
    yystate(6, Ics, Line + 1, Tlen + 1, 15, Tlen);
...
yystate(1, [C | Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 91 ->
    yystate(6, Ics, Line, Tlen + 1, Action, Alen);
yystate(1, [C | Ics], Line, Tlen, Action, Alen) when C >= 97 ->
    yystate(6, Ics, Line, Tlen + 1, Action, Alen);
...
-file("/home/mariano/src/erl/dtu/src/dtu_lexer.xrl", 40).
